...
setup(
    name='topology_docker_ryu',
    version=find_version('lib/topology_docker_ryu/__init__.py'),
    package_dir={'': 'lib'},
    ...
    description=(
        'A Topology Ryu Node for topology_docker.'
    ),
    long_description=read('README.rst'),
    url='https://github.com/HPENetworking/topology_docker_ryu/tree/master/doc',
    keywords='topology_docker_ryu',
    ...
    entry_points={
        'topology_docker_node_10': [
            'ryu = topology_docker_ryu.ryu:RyuNode'
        ]
    }
)
